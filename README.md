...
- **Data Persistence**: The application now uses `localStorage` to save book data, ensuring that even after refreshing the page, all books and their statuses are retained.
- **Total Pages of Read Books**: The total number of pages from books marked as read is displayed.
- **Delete All Books**: A new "Delete Books" button allows users to remove all books from the library with a single click.
...
5. **Delete All Books**: Use the "Delete Books" button to clear all books from the library.
...
- **Persistência de Dados**: A aplicação agora utiliza `localStorage` para salvar os dados dos livros, garantindo que, mesmo após atualizar a página, todos os livros e seus status sejam mantidos.
- **Total de Páginas Lidas**: O total de páginas dos livros marcados como lidos é exibido.
- **Excluir Todos os Livros**: Um novo botão "Delete Books" permite que os usuários removam todos os livros da biblioteca com um único clique.
...
5. **Excluir Todos os Livros**: Use o botão "Delete Books" para limpar todos os livros da biblioteca.
